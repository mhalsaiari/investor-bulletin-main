...
from resources.alert_rules.alert_rule_schema import AlertRuleCreate, AlertRuleUpdate,AlertRuleSchema
...
@router.patch("/{id}")
def update_alert_rule(id: int, alert_rule: AlertRuleUpdate, db: session= Depends(get_db)):
